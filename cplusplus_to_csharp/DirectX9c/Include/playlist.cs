...
public enum AMPlayListItemFlags
{
    ...
    public class IAMPlayListItemVtbl
    {
// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: BEGIN_INTERFACE int(STDMETHODCALLTYPE __RPC_FAR *QueryInterface)(interface IAMPlayListItem __RPC_FAR * This, REFIID riid, void __RPC_FAR *__RPC_FAR *ppvObject);
        public delegate BEGIN_INTERFACE int QueryInterfaceDelegate(@interface IAMPlayListItem __RPC_FAR This, REFIID riid, void __RPC_FAR * __RPC_FAR ppvObject);
        public QueryInterfaceDelegate QueryInterface;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: uint(STDMETHODCALLTYPE __RPC_FAR *AddRef)(interface IAMPlayListItem __RPC_FAR * This);
        public delegate uint AddRefDelegate(@interface IAMPlayListItem __RPC_FAR This);
        public AddRefDelegate AddRef;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: uint(STDMETHODCALLTYPE __RPC_FAR *Release)(interface IAMPlayListItem __RPC_FAR * This);
        public delegate uint ReleaseDelegate(@interface IAMPlayListItem __RPC_FAR This);
        public ReleaseDelegate Release;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE __RPC_FAR *GetFlags)(interface IAMPlayListItem __RPC_FAR * This, uint __RPC_FAR *pdwFlags);
        public delegate int GetFlagsDelegate(@interface IAMPlayListItem __RPC_FAR This, ref uint __RPC_FAR pdwFlags);
        public GetFlagsDelegate GetFlags;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE __RPC_FAR *GetSourceCount)(interface IAMPlayListItem __RPC_FAR * This, uint __RPC_FAR *pdwSources);
        public delegate int GetSourceCountDelegate(@interface IAMPlayListItem __RPC_FAR This, ref uint __RPC_FAR pdwSources);
        public GetSourceCountDelegate GetSourceCount;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE __RPC_FAR *GetSourceURL)(interface IAMPlayListItem __RPC_FAR * This, uint dwSourceIndex, char* __RPC_FAR *pbstrURL);
        public delegate int GetSourceURLDelegate(@interface IAMPlayListItem __RPC_FAR This, uint dwSourceIndex, ref string * __RPC_FAR pbstrURL);
        public GetSourceURLDelegate GetSourceURL;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE __RPC_FAR *GetSourceStart)(interface IAMPlayListItem __RPC_FAR * This, uint dwSourceIndex, REFERENCE_TIME __RPC_FAR *prtStart);
        public delegate int GetSourceStartDelegate(@interface IAMPlayListItem __RPC_FAR This, uint dwSourceIndex, REFERENCE_TIME __RPC_FAR prtStart);
        public GetSourceStartDelegate GetSourceStart;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE __RPC_FAR *GetSourceDuration)(interface IAMPlayListItem __RPC_FAR * This, uint dwSourceIndex, REFERENCE_TIME __RPC_FAR *prtDuration);
        public delegate int GetSourceDurationDelegate(@interface IAMPlayListItem __RPC_FAR This, uint dwSourceIndex, REFERENCE_TIME __RPC_FAR prtDuration);
        public GetSourceDurationDelegate GetSourceDuration;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE __RPC_FAR *GetSourceStartMarker)(interface IAMPlayListItem __RPC_FAR * This, uint dwSourceIndex, uint __RPC_FAR *pdwMarker);
        public delegate int GetSourceStartMarkerDelegate(@interface IAMPlayListItem __RPC_FAR This, uint dwSourceIndex, ref uint __RPC_FAR pdwMarker);
        public GetSourceStartMarkerDelegate GetSourceStartMarker;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE __RPC_FAR *GetSourceEndMarker)(interface IAMPlayListItem __RPC_FAR * This, uint dwSourceIndex, uint __RPC_FAR *pdwMarker);
        public delegate int GetSourceEndMarkerDelegate(@interface IAMPlayListItem __RPC_FAR This, uint dwSourceIndex, ref uint __RPC_FAR pdwMarker);
        public GetSourceEndMarkerDelegate GetSourceEndMarker;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE __RPC_FAR *GetSourceStartMarkerName)(interface IAMPlayListItem __RPC_FAR * This, uint dwSourceIndex, char* __RPC_FAR *pbstrStartMarker);
        public delegate int GetSourceStartMarkerNameDelegate(@interface IAMPlayListItem __RPC_FAR This, uint dwSourceIndex, ref string * __RPC_FAR pbstrStartMarker);
        public GetSourceStartMarkerNameDelegate GetSourceStartMarkerName;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE __RPC_FAR *GetSourceEndMarkerName)(interface IAMPlayListItem __RPC_FAR * This, uint dwSourceIndex, char* __RPC_FAR *pbstrEndMarker);
        public delegate int GetSourceEndMarkerNameDelegate(@interface IAMPlayListItem __RPC_FAR This, uint dwSourceIndex, ref string * __RPC_FAR pbstrEndMarker);
        public GetSourceEndMarkerNameDelegate GetSourceEndMarkerName;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE __RPC_FAR *GetLinkURL)(interface IAMPlayListItem __RPC_FAR * This, char* __RPC_FAR *pbstrURL);
        public delegate int GetLinkURLDelegate(@interface IAMPlayListItem __RPC_FAR This, ref string * __RPC_FAR pbstrURL);
        public GetLinkURLDelegate GetLinkURL;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE __RPC_FAR *GetScanDuration)(interface IAMPlayListItem __RPC_FAR * This, uint dwSourceIndex, REFERENCE_TIME __RPC_FAR *prtScanDuration);
        public delegate int GetScanDurationDelegate(@interface IAMPlayListItem __RPC_FAR This, uint dwSourceIndex, REFERENCE_TIME __RPC_FAR prtScanDuration);
        public GetScanDurationDelegate GetScanDuration;
...
public enum AMPlayListEventFlags
{
    ...
    public class IAMPlayListVtbl
    {
// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: BEGIN_INTERFACE int(STDMETHODCALLTYPE __RPC_FAR *QueryInterface)(interface IAMPlayList __RPC_FAR * This, REFIID riid, void __RPC_FAR *__RPC_FAR *ppvObject);
        public delegate BEGIN_INTERFACE int QueryInterfaceDelegate(@interface IAMPlayList __RPC_FAR This, REFIID riid, void __RPC_FAR * __RPC_FAR ppvObject);
        public QueryInterfaceDelegate QueryInterface;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: uint(STDMETHODCALLTYPE __RPC_FAR *AddRef)(interface IAMPlayList __RPC_FAR * This);
        public delegate uint AddRefDelegate(@interface IAMPlayList __RPC_FAR This);
        public AddRefDelegate AddRef;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: uint(STDMETHODCALLTYPE __RPC_FAR *Release)(interface IAMPlayList __RPC_FAR * This);
        public delegate uint ReleaseDelegate(@interface IAMPlayList __RPC_FAR This);
        public ReleaseDelegate Release;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE __RPC_FAR *GetFlags)(interface IAMPlayList __RPC_FAR * This, uint __RPC_FAR *pdwFlags);
        public delegate int GetFlagsDelegate(@interface IAMPlayList __RPC_FAR This, ref uint __RPC_FAR pdwFlags);
        public GetFlagsDelegate GetFlags;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE __RPC_FAR *GetItemCount)(interface IAMPlayList __RPC_FAR * This, uint __RPC_FAR *pdwItems);
        public delegate int GetItemCountDelegate(@interface IAMPlayList __RPC_FAR This, ref uint __RPC_FAR pdwItems);
        public GetItemCountDelegate GetItemCount;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE __RPC_FAR *GetItem)(interface IAMPlayList __RPC_FAR * This, uint dwItemIndex, interface IAMPlayListItem __RPC_FAR *__RPC_FAR *ppItem);
        public delegate int GetItemDelegate(@interface IAMPlayList __RPC_FAR This, uint dwItemIndex, @interface IAMPlayListItem __RPC_FAR * __RPC_FAR ppItem);
        public GetItemDelegate GetItem;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE __RPC_FAR *GetNamedEvent)(interface IAMPlayList __RPC_FAR * This, char __RPC_FAR *pwszEventName, uint dwItemIndex, interface IAMPlayListItem __RPC_FAR *__RPC_FAR *ppItem, uint __RPC_FAR *pdwFlags);
        public delegate int GetNamedEventDelegate(@interface IAMPlayList __RPC_FAR This, ref string __RPC_FAR pwszEventName, uint dwItemIndex, @interface IAMPlayListItem __RPC_FAR * __RPC_FAR ppItem, ref uint __RPC_FAR pdwFlags);
        public GetNamedEventDelegate GetNamedEvent;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE __RPC_FAR *GetRepeatInfo)(interface IAMPlayList __RPC_FAR * This, uint __RPC_FAR *pdwRepeatCount, uint __RPC_FAR *pdwRepeatStart, uint __RPC_FAR *pdwRepeatEnd);
        public delegate int GetRepeatInfoDelegate(@interface IAMPlayList __RPC_FAR This, ref uint __RPC_FAR pdwRepeatCount, ref uint __RPC_FAR pdwRepeatStart, ref uint __RPC_FAR pdwRepeatEnd);
        public GetRepeatInfoDelegate GetRepeatInfo;
...
//        END_INTERFACE
    ...
    public class ISpecifyParticularPagesVtbl
    {
// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: BEGIN_INTERFACE int(STDMETHODCALLTYPE __RPC_FAR *QueryInterface)(interface ISpecifyParticularPages __RPC_FAR * This, REFIID riid, void __RPC_FAR *__RPC_FAR *ppvObject);
        public delegate BEGIN_INTERFACE int QueryInterfaceDelegate(@interface ISpecifyParticularPages __RPC_FAR This, REFIID riid, void __RPC_FAR * __RPC_FAR ppvObject);
        public QueryInterfaceDelegate QueryInterface;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: uint(STDMETHODCALLTYPE __RPC_FAR *AddRef)(interface ISpecifyParticularPages __RPC_FAR * This);
        public delegate uint AddRefDelegate(@interface ISpecifyParticularPages __RPC_FAR This);
        public AddRefDelegate AddRef;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: uint(STDMETHODCALLTYPE __RPC_FAR *Release)(interface ISpecifyParticularPages __RPC_FAR * This);
        public delegate uint ReleaseDelegate(@interface ISpecifyParticularPages __RPC_FAR This);
        public ReleaseDelegate Release;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE __RPC_FAR *GetPages)(interface ISpecifyParticularPages __RPC_FAR * This, REFGUID guidWhatPages, CAUUID __RPC_FAR *pPages);
        public delegate int GetPagesDelegate(@interface ISpecifyParticularPages __RPC_FAR This, REFGUID guidWhatPages, CAUUID __RPC_FAR pPages);
        public GetPagesDelegate GetPages;
...
//        END_INTERFACE
    ...
    public class IAMRebuildVtbl
    {
// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: BEGIN_INTERFACE int(STDMETHODCALLTYPE __RPC_FAR *QueryInterface)(interface IAMRebuild __RPC_FAR * This, REFIID riid, void __RPC_FAR *__RPC_FAR *ppvObject);
        public delegate BEGIN_INTERFACE int QueryInterfaceDelegate(@interface IAMRebuild __RPC_FAR This, REFIID riid, void __RPC_FAR * __RPC_FAR ppvObject);
        public QueryInterfaceDelegate QueryInterface;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: uint(STDMETHODCALLTYPE __RPC_FAR *AddRef)(interface IAMRebuild __RPC_FAR * This);
        public delegate uint AddRefDelegate(@interface IAMRebuild __RPC_FAR This);
        public AddRefDelegate AddRef;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: uint(STDMETHODCALLTYPE __RPC_FAR *Release)(interface IAMRebuild __RPC_FAR * This);
        public delegate uint ReleaseDelegate(@interface IAMRebuild __RPC_FAR This);
        public ReleaseDelegate Release;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE __RPC_FAR *RebuildNow)(interface IAMRebuild __RPC_FAR * This);
        public delegate int RebuildNowDelegate(@interface IAMRebuild __RPC_FAR This);
        public RebuildNowDelegate RebuildNow;
