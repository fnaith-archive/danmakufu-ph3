...
// ORIGINAL LINE: typedef void(__cdecl *D3DRMOBJECTCALLBACK)(interface IDirect3DRMObject FAR * obj, object* arg);
public delegate void D3DRMOBJECTCALLBACK(@interface IDirect3DRMObject obj, object arg);
// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: typedef void(__cdecl *D3DRMFRAMEMOVECALLBACK)(interface IDirect3DRMFrame FAR * obj, object* arg, float delta);
public delegate void D3DRMFRAMEMOVECALLBACK(@interface IDirect3DRMFrame obj, object arg, float delta);
// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: typedef void(__cdecl *D3DRMFRAME3MOVECALLBACK)(interface IDirect3DRMFrame3 FAR * obj, object* arg, float delta);
public delegate void D3DRMFRAME3MOVECALLBACK(@interface IDirect3DRMFrame3 obj, object arg, float delta);
// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: typedef void(__cdecl *D3DRMUPDATECALLBACK)(interface IDirect3DRMDevice FAR * obj, object* arg, int, struct _D3DRECT *);
public delegate void D3DRMUPDATECALLBACK(@interface IDirect3DRMDevice obj, object arg, int UnnamedParameter, _D3DRECT UnnamedParameter2);
// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: typedef void(__cdecl *D3DRMDEVICE3UPDATECALLBACK)(interface IDirect3DRMDevice3 FAR * obj, object* arg, int, struct _D3DRECT *);
public delegate void D3DRMDEVICE3UPDATECALLBACK(@interface IDirect3DRMDevice3 obj, object arg, int UnnamedParameter, _D3DRECT UnnamedParameter2);
// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: typedef int(__cdecl *D3DRMUSERVISUALCALLBACK)(interface IDirect3DRMUserVisual FAR * obj, object* arg, D3DRMUSERVISUALREASON reason, interface IDirect3DRMDevice FAR * dev, interface IDirect3DRMViewport FAR * view);
public delegate int D3DRMUSERVISUALCALLBACK(@interface IDirect3DRMUserVisual obj, object arg, D3DRMUSERVISUALREASON reason, @interface IDirect3DRMDevice dev, @interface IDirect3DRMViewport view);
// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: typedef int(__cdecl *D3DRMLOADTEXTURECALLBACK)(char *tex_name, object* arg, interface IDirect3DRMTexture FAR **);
public delegate int D3DRMLOADTEXTURECALLBACK(ref string tex_name, object arg, @interface[] IDirect3DRMTexture);
// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: typedef int(__cdecl *D3DRMLOADTEXTURE3CALLBACK)(char *tex_name, object* arg, interface IDirect3DRMTexture3 FAR **);
public delegate int D3DRMLOADTEXTURE3CALLBACK(ref string tex_name, object arg, @interface[] IDirect3DRMTexture3);
// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: typedef void(__cdecl *D3DRMLOADCALLBACK)(interface IDirect3DRMObject FAR * object, REFIID objectguid, object* arg);
public delegate void D3DRMLOADCALLBACK(@interface IDirect3DRMObject @object, REFIID objectguid, object arg);

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: typedef int(__cdecl *D3DRMDOWNSAMPLECALLBACK)(interface IDirect3DRMTexture3 FAR * lpDirect3DRMTexture, object* pArg, LPDIRECTDRAWSURFACE pDDSSrc, LPDIRECTDRAWSURFACE pDDSDst);
public delegate int D3DRMDOWNSAMPLECALLBACK(@interface IDirect3DRMTexture3 lpDirect3DRMTexture, object pArg, LPDIRECTDRAWSURFACE pDDSSrc, LPDIRECTDRAWSURFACE pDDSDst);
// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: typedef int(__cdecl *D3DRMVALIDATIONCALLBACK)(interface IDirect3DRMTexture3 FAR * lpDirect3DRMTexture, object* pArg, uint dwFlags, uint dwcRects, LPRECT pRects);
public delegate int D3DRMVALIDATIONCALLBACK(@interface IDirect3DRMTexture3 lpDirect3DRMTexture, object pArg, uint dwFlags, uint dwcRects, LPRECT pRects);


public class _D3DRMPICKDESC
{
    public uint ulFaceIdx;
    public int lGroupIdx;
    public _D3DVECTOR vPosition = new _D3DVECTOR();

}

public class _D3DRMPICKDESC2
{
    public uint ulFaceIdx;
    public int lGroupIdx;
    public _D3DVECTOR dvPosition = new _D3DVECTOR();
    public float tu;
    public float tv;
    public _D3DVECTOR dvNormal = new _D3DVECTOR();
    public uint dcColor;
