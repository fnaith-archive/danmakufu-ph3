...
// #include "wmsdkidl.h"
    ...
    public class IConfigAsfWriterVtbl
    {
// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: BEGIN_INTERFACE int(STDMETHODCALLTYPE *QueryInterface)(interface IConfigAsfWriter * This, REFIID riid, object**ppvObject);
        public delegate BEGIN_INTERFACE int QueryInterfaceDelegate(@interface IConfigAsfWriter This, REFIID riid, object ppvObject[] UnnamedParameter);
        public QueryInterfaceDelegate QueryInterface;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: uint(STDMETHODCALLTYPE *AddRef)(interface IConfigAsfWriter * This);
        public delegate uint AddRefDelegate(@interface IConfigAsfWriter This);
        public AddRefDelegate AddRef;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: uint(STDMETHODCALLTYPE *Release)(interface IConfigAsfWriter * This);
        public delegate uint ReleaseDelegate(@interface IConfigAsfWriter This);
        public ReleaseDelegate Release;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *ConfigureFilterUsingProfileId)(interface IConfigAsfWriter * This, uint dwProfileId);
        public delegate int ConfigureFilterUsingProfileIdDelegate(@interface IConfigAsfWriter This, uint dwProfileId);
        public ConfigureFilterUsingProfileIdDelegate ConfigureFilterUsingProfileId;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *GetCurrentProfileId)(interface IConfigAsfWriter * This, uint *pdwProfileId);
        public delegate int GetCurrentProfileIdDelegate(@interface IConfigAsfWriter This, ref uint pdwProfileId);
        public GetCurrentProfileIdDelegate GetCurrentProfileId;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *ConfigureFilterUsingProfileGuid)(interface IConfigAsfWriter * This, REFGUID guidProfile);
        public delegate int ConfigureFilterUsingProfileGuidDelegate(@interface IConfigAsfWriter This, REFGUID guidProfile);
        public ConfigureFilterUsingProfileGuidDelegate ConfigureFilterUsingProfileGuid;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *GetCurrentProfileGuid)(interface IConfigAsfWriter * This, GUID *pProfileGuid);
        public delegate int GetCurrentProfileGuidDelegate(@interface IConfigAsfWriter This, GUID pProfileGuid);
        public GetCurrentProfileGuidDelegate GetCurrentProfileGuid;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *ConfigureFilterUsingProfile)(interface IConfigAsfWriter * This, IWMProfile *pProfile);
        public delegate int ConfigureFilterUsingProfileDelegate(@interface IConfigAsfWriter This, IWMProfile pProfile);
        public ConfigureFilterUsingProfileDelegate ConfigureFilterUsingProfile;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *GetCurrentProfile)(interface IConfigAsfWriter * This, IWMProfile **ppProfile);
        public delegate int GetCurrentProfileDelegate(@interface IConfigAsfWriter This, IWMProfile[] ppProfile);
        public GetCurrentProfileDelegate GetCurrentProfile;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *SetIndexMode)(interface IConfigAsfWriter * This, bool bIndexFile);
        public delegate int SetIndexModeDelegate(@interface IConfigAsfWriter This, bool bIndexFile);
        public SetIndexModeDelegate SetIndexMode;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *GetIndexMode)(interface IConfigAsfWriter * This, bool *pbIndexFile);
        public delegate int GetIndexModeDelegate(@interface IConfigAsfWriter This, ref bool pbIndexFile);
        public GetIndexModeDelegate GetIndexMode;
