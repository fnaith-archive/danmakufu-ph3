...
// ORIGINAL LINE: typedef void(WINAPI *LPD3DXFILL2D)(D3DXVECTOR4 *pOut, CONST D3DXVECTOR2 *pTexCoord, CONST D3DXVECTOR2 *pTexelSize, object* pData);
public delegate void LPD3DXFILL2D(D3DXVECTOR4 pOut, CONST D3DXVECTOR2 pTexCoord, CONST D3DXVECTOR2 pTexelSize, object pData);

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: typedef void(WINAPI *LPD3DXFILL3D)(D3DXVECTOR4 *pOut, CONST D3DXVECTOR3 *pTexCoord, CONST D3DXVECTOR3 *pTexelSize, object* pData);
public delegate void LPD3DXFILL3D(D3DXVECTOR4 pOut, CONST D3DXVECTOR3 pTexCoord, CONST D3DXVECTOR3 pTexelSize, object pData);
