...
public enum _D3DXPARAMETERTYPE
{
    D3DXPT_DWORD = 0,
    D3DXPT_FLOAT = 1,
    D3DXPT_VECTOR = 2,
...
public partial class _D3DXPARAMETER_DESC
{
    ...
    public D3DXPARAMETERTYPE Type = new D3DXPARAMETERTYPE();
...
// C++ TO C# CONVERTER TODO TASK: The typedef 'ID3DXEffect' was defined in multiple preprocessor conditionals and cannot be replaced in-line:
