...
// ORIGINAL LINE: #define IVPManager_GetVideoPortIndex(This,pdwVideoPortIndex) (This)->lpVtbl -> GetVideoPortIndex(This,pdwVideoPortIndex)
    ...
    public class IStreamBufferInitializeVtbl
    {
// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: BEGIN_INTERFACE int(STDMETHODCALLTYPE *QueryInterface)(interface IStreamBufferInitialize * This, REFIID riid, object**ppvObject);
        public delegate BEGIN_INTERFACE int QueryInterfaceDelegate(@interface IStreamBufferInitialize This, REFIID riid, object ppvObject[] UnnamedParameter);
        public QueryInterfaceDelegate QueryInterface;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: uint(STDMETHODCALLTYPE *AddRef)(interface IStreamBufferInitialize * This);
        public delegate uint AddRefDelegate(@interface IStreamBufferInitialize This);
        public AddRefDelegate AddRef;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: uint(STDMETHODCALLTYPE *Release)(interface IStreamBufferInitialize * This);
        public delegate uint ReleaseDelegate(@interface IStreamBufferInitialize This);
        public ReleaseDelegate Release;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *SetHKEY)(interface IStreamBufferInitialize * This, System.IntPtr hkeyRoot);
        public delegate int SetHKEYDelegate(@interface IStreamBufferInitialize This, IntPtr hkeyRoot);
        public SetHKEYDelegate SetHKEY;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *SetSIDs)(interface IStreamBufferInitialize * This, uint cSIDs, PSID *ppSID);
        public delegate int SetSIDsDelegate(@interface IStreamBufferInitialize This, uint cSIDs, PSID ppSID);
        public SetSIDsDelegate SetSIDs;
...
public enum __MIDL___MIDL_itf_sbe_0408_0001
{
    ...
    public class IStreamBufferSinkVtbl
    {
// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: BEGIN_INTERFACE int(STDMETHODCALLTYPE *QueryInterface)(interface IStreamBufferSink * This, REFIID riid, object**ppvObject);
        public delegate BEGIN_INTERFACE int QueryInterfaceDelegate(@interface IStreamBufferSink This, REFIID riid, object ppvObject[] UnnamedParameter);
        public QueryInterfaceDelegate QueryInterface;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: uint(STDMETHODCALLTYPE *AddRef)(interface IStreamBufferSink * This);
        public delegate uint AddRefDelegate(@interface IStreamBufferSink This);
        public AddRefDelegate AddRef;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: uint(STDMETHODCALLTYPE *Release)(interface IStreamBufferSink * This);
        public delegate uint ReleaseDelegate(@interface IStreamBufferSink This);
        public ReleaseDelegate Release;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *LockProfile)(interface IStreamBufferSink * This, const char* pszStreamBufferFilename);
        public delegate int LockProfileDelegate(@interface IStreamBufferSink This, string pszStreamBufferFilename);
        public LockProfileDelegate LockProfile;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *CreateRecorder)(interface IStreamBufferSink * This, const char* pszFilename, uint dwRecordType, object**pRecordingIUnknown);
        public delegate int CreateRecorderDelegate(@interface IStreamBufferSink This, string pszFilename, uint dwRecordType, object pRecordingIUnknown[] UnnamedParameter);
        public CreateRecorderDelegate CreateRecorder;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *IsProfileLocked)(interface IStreamBufferSink * This);
        public delegate int IsProfileLockedDelegate(@interface IStreamBufferSink This);
        public IsProfileLockedDelegate IsProfileLocked;
...
//        END_INTERFACE
    ...
    public class IStreamBufferSourceVtbl
    {
// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: BEGIN_INTERFACE int(STDMETHODCALLTYPE *QueryInterface)(interface IStreamBufferSource * This, REFIID riid, object**ppvObject);
        public delegate BEGIN_INTERFACE int QueryInterfaceDelegate(@interface IStreamBufferSource This, REFIID riid, object ppvObject[] UnnamedParameter);
        public QueryInterfaceDelegate QueryInterface;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: uint(STDMETHODCALLTYPE *AddRef)(interface IStreamBufferSource * This);
        public delegate uint AddRefDelegate(@interface IStreamBufferSource This);
        public AddRefDelegate AddRef;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: uint(STDMETHODCALLTYPE *Release)(interface IStreamBufferSource * This);
        public delegate uint ReleaseDelegate(@interface IStreamBufferSource This);
        public ReleaseDelegate Release;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *SetStreamSink)(interface IStreamBufferSource * This, interface IStreamBufferSink *pIStreamBufferSink);
        public delegate int SetStreamSinkDelegate(@interface IStreamBufferSource This, @interface IStreamBufferSink pIStreamBufferSink);
        public SetStreamSinkDelegate SetStreamSink;
...
//        END_INTERFACE
    ...
    public class IStreamBufferRecordControlVtbl
    {
// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: BEGIN_INTERFACE int(STDMETHODCALLTYPE *QueryInterface)(interface IStreamBufferRecordControl * This, REFIID riid, object**ppvObject);
        public delegate BEGIN_INTERFACE int QueryInterfaceDelegate(@interface IStreamBufferRecordControl This, REFIID riid, object ppvObject[] UnnamedParameter);
        public QueryInterfaceDelegate QueryInterface;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: uint(STDMETHODCALLTYPE *AddRef)(interface IStreamBufferRecordControl * This);
        public delegate uint AddRefDelegate(@interface IStreamBufferRecordControl This);
        public AddRefDelegate AddRef;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: uint(STDMETHODCALLTYPE *Release)(interface IStreamBufferRecordControl * This);
        public delegate uint ReleaseDelegate(@interface IStreamBufferRecordControl This);
        public ReleaseDelegate Release;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *Start)(interface IStreamBufferRecordControl * This, REFERENCE_TIME *prtStart);
        public delegate int StartDelegate(@interface IStreamBufferRecordControl This, REFERENCE_TIME prtStart);
        public StartDelegate Start;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *Stop)(interface IStreamBufferRecordControl * This, REFERENCE_TIME rtStop);
        public delegate int StopDelegate(@interface IStreamBufferRecordControl This, REFERENCE_TIME rtStop);
        public StopDelegate Stop;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *GetRecordingStatus)(interface IStreamBufferRecordControl * This, int *phResult, bool *pbStarted, bool *pbStopped);
        public delegate int GetRecordingStatusDelegate(@interface IStreamBufferRecordControl This, ref int phResult, ref bool pbStarted, ref bool pbStopped);
        public GetRecordingStatusDelegate GetRecordingStatus;
...
//        END_INTERFACE
    ...
    public class IStreamBufferRecCompVtbl
    {
// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: BEGIN_INTERFACE int(STDMETHODCALLTYPE *QueryInterface)(interface IStreamBufferRecComp * This, REFIID riid, object**ppvObject);
        public delegate BEGIN_INTERFACE int QueryInterfaceDelegate(@interface IStreamBufferRecComp This, REFIID riid, object ppvObject[] UnnamedParameter);
        public QueryInterfaceDelegate QueryInterface;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: uint(STDMETHODCALLTYPE *AddRef)(interface IStreamBufferRecComp * This);
        public delegate uint AddRefDelegate(@interface IStreamBufferRecComp This);
        public AddRefDelegate AddRef;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: uint(STDMETHODCALLTYPE *Release)(interface IStreamBufferRecComp * This);
        public delegate uint ReleaseDelegate(@interface IStreamBufferRecComp This);
        public ReleaseDelegate Release;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *Initialize)(interface IStreamBufferRecComp * This, const char* pszTargetFilename, const char* pszSBRecProfileRef);
        public delegate int InitializeDelegate(@interface IStreamBufferRecComp This, string pszTargetFilename, string pszSBRecProfileRef);
        public InitializeDelegate Initialize;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *Append)(interface IStreamBufferRecComp * This, const char* pszSBRecording);
        public delegate int AppendDelegate(@interface IStreamBufferRecComp This, string pszSBRecording);
        public AppendDelegate Append;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *AppendEx)(interface IStreamBufferRecComp * This, const char* pszSBRecording, REFERENCE_TIME rtStart, REFERENCE_TIME rtStop);
        public delegate int AppendExDelegate(@interface IStreamBufferRecComp This, string pszSBRecording, REFERENCE_TIME rtStart, REFERENCE_TIME rtStop);
        public AppendExDelegate AppendEx;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *GetCurrentLength)(interface IStreamBufferRecComp * This, uint *pcSeconds);
        public delegate int GetCurrentLengthDelegate(@interface IStreamBufferRecComp This, ref uint pcSeconds);
        public GetCurrentLengthDelegate GetCurrentLength;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *Close)(interface IStreamBufferRecComp * This);
        public delegate int CloseDelegate(@interface IStreamBufferRecComp This);
        public CloseDelegate Close;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *Cancel)(interface IStreamBufferRecComp * This);
        public delegate int CancelDelegate(@interface IStreamBufferRecComp This);
        public CancelDelegate Cancel;

//        END_INTERFACE
    }

public enum __MIDL___MIDL_itf_sbe_0412_0001
{
    ...
    public class IStreamBufferRecordingAttributeVtbl
    {
// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: BEGIN_INTERFACE int(STDMETHODCALLTYPE *QueryInterface)(interface IStreamBufferRecordingAttribute * This, REFIID riid, object**ppvObject);
        public delegate BEGIN_INTERFACE int QueryInterfaceDelegate(@interface IStreamBufferRecordingAttribute This, REFIID riid, object ppvObject[] UnnamedParameter);
        public QueryInterfaceDelegate QueryInterface;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: uint(STDMETHODCALLTYPE *AddRef)(interface IStreamBufferRecordingAttribute * This);
        public delegate uint AddRefDelegate(@interface IStreamBufferRecordingAttribute This);
        public AddRefDelegate AddRef;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: uint(STDMETHODCALLTYPE *Release)(interface IStreamBufferRecordingAttribute * This);
        public delegate uint ReleaseDelegate(@interface IStreamBufferRecordingAttribute This);
        public ReleaseDelegate Release;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *SetAttribute)(interface IStreamBufferRecordingAttribute * This, uint ulReserved, const char* pszAttributeName, STREAMBUFFER_ATTR_DATATYPE StreamBufferAttributeType, byte *pbAttribute, ushort cbAttributeLength);
        public delegate int SetAttributeDelegate(@interface IStreamBufferRecordingAttribute This, uint ulReserved, string pszAttributeName, STREAMBUFFER_ATTR_DATATYPE StreamBufferAttributeType, ref byte pbAttribute, ushort cbAttributeLength);
        public SetAttributeDelegate SetAttribute;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *GetAttributeCount)(interface IStreamBufferRecordingAttribute * This, uint ulReserved, ushort *pcAttributes);
        public delegate int GetAttributeCountDelegate(@interface IStreamBufferRecordingAttribute This, uint ulReserved, ref ushort pcAttributes);
        public GetAttributeCountDelegate GetAttributeCount;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *GetAttributeByName)(interface IStreamBufferRecordingAttribute * This, const char* pszAttributeName, uint *pulReserved, STREAMBUFFER_ATTR_DATATYPE *pStreamBufferAttributeType, byte *pbAttribute, ushort *pcbLength);
        public delegate int GetAttributeByNameDelegate(@interface IStreamBufferRecordingAttribute This, string pszAttributeName, ref uint pulReserved, STREAMBUFFER_ATTR_DATATYPE pStreamBufferAttributeType, ref byte pbAttribute, ref ushort pcbLength);
        public GetAttributeByNameDelegate GetAttributeByName;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *GetAttributeByIndex)(interface IStreamBufferRecordingAttribute * This, ushort wIndex, uint *pulReserved, char *pszAttributeName, ushort *pcchNameLength, STREAMBUFFER_ATTR_DATATYPE *pStreamBufferAttributeType, byte *pbAttribute, ushort *pcbLength);
        public delegate int GetAttributeByIndexDelegate(@interface IStreamBufferRecordingAttribute This, ushort wIndex, ref uint pulReserved, ref string pszAttributeName, ref ushort pcchNameLength, STREAMBUFFER_ATTR_DATATYPE pStreamBufferAttributeType, ref byte pbAttribute, ref ushort pcbLength);
        public GetAttributeByIndexDelegate GetAttributeByIndex;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *EnumAttributes)(interface IStreamBufferRecordingAttribute * This, interface IEnumStreamBufferRecordingAttrib **ppIEnumStreamBufferAttrib);
        public delegate int EnumAttributesDelegate(@interface IStreamBufferRecordingAttribute This, @interface IEnumStreamBufferRecordingAttrib[] ppIEnumStreamBufferAttrib);
        public EnumAttributesDelegate EnumAttributes;
...
public class __MIDL___MIDL_itf_sbe_0413_0001
{
    public string pszName;
    public STREAMBUFFER_ATTR_DATATYPE StreamBufferAttributeType = new STREAMBUFFER_ATTR_DATATYPE();
// C++ TO C# CONVERTER TODO TASK: C# does not have an equivalent to pointers to value types:
// ORIGINAL LINE: byte *pbAttribute;
    public byte pbAttribute;
    public ushort cbLength;
}

#else // C style interface

    public class IEnumStreamBufferRecordingAttribVtbl
    {
// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: BEGIN_INTERFACE int(STDMETHODCALLTYPE *QueryInterface)(interface IEnumStreamBufferRecordingAttrib * This, REFIID riid, object**ppvObject);
        public delegate BEGIN_INTERFACE int QueryInterfaceDelegate(@interface IEnumStreamBufferRecordingAttrib This, REFIID riid, object ppvObject[] UnnamedParameter);
        public QueryInterfaceDelegate QueryInterface;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: uint(STDMETHODCALLTYPE *AddRef)(interface IEnumStreamBufferRecordingAttrib * This);
        public delegate uint AddRefDelegate(@interface IEnumStreamBufferRecordingAttrib This);
        public AddRefDelegate AddRef;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: uint(STDMETHODCALLTYPE *Release)(interface IEnumStreamBufferRecordingAttrib * This);
        public delegate uint ReleaseDelegate(@interface IEnumStreamBufferRecordingAttrib This);
        public ReleaseDelegate Release;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *Next)(interface IEnumStreamBufferRecordingAttrib * This, uint cRequest, __MIDL___MIDL_itf_sbe_0413_0001 *pStreamBufferAttribute, uint *pcReceived);
        public delegate int NextDelegate(@interface IEnumStreamBufferRecordingAttrib This, uint cRequest, __MIDL___MIDL_itf_sbe_0413_0001 pStreamBufferAttribute, ref uint pcReceived);
        public NextDelegate Next;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *Skip)(interface IEnumStreamBufferRecordingAttrib * This, uint cRecords);
        public delegate int SkipDelegate(@interface IEnumStreamBufferRecordingAttrib This, uint cRecords);
        public SkipDelegate Skip;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *Reset)(interface IEnumStreamBufferRecordingAttrib * This);
        public delegate int ResetDelegate(@interface IEnumStreamBufferRecordingAttrib This);
        public ResetDelegate Reset;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *Clone)(interface IEnumStreamBufferRecordingAttrib * This, interface IEnumStreamBufferRecordingAttrib **ppIEnumStreamBufferAttrib);
        public delegate int CloneDelegate(@interface IEnumStreamBufferRecordingAttrib This, @interface IEnumStreamBufferRecordingAttrib[] ppIEnumStreamBufferAttrib);
...
//        END_INTERFACE
    ...
    public class IStreamBufferConfigureVtbl
    {
// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: BEGIN_INTERFACE int(STDMETHODCALLTYPE *QueryInterface)(interface IStreamBufferConfigure * This, REFIID riid, object**ppvObject);
        public delegate BEGIN_INTERFACE int QueryInterfaceDelegate(@interface IStreamBufferConfigure This, REFIID riid, object ppvObject[] UnnamedParameter);
        public QueryInterfaceDelegate QueryInterface;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: uint(STDMETHODCALLTYPE *AddRef)(interface IStreamBufferConfigure * This);
        public delegate uint AddRefDelegate(@interface IStreamBufferConfigure This);
        public AddRefDelegate AddRef;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: uint(STDMETHODCALLTYPE *Release)(interface IStreamBufferConfigure * This);
        public delegate uint ReleaseDelegate(@interface IStreamBufferConfigure This);
        public ReleaseDelegate Release;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *SetDirectory)(interface IStreamBufferConfigure * This, const char* pszDirectoryName);
        public delegate int SetDirectoryDelegate(@interface IStreamBufferConfigure This, string pszDirectoryName);
        public SetDirectoryDelegate SetDirectory;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *GetDirectory)(interface IStreamBufferConfigure * This, char**ppszDirectoryName);
        public delegate int GetDirectoryDelegate(@interface IStreamBufferConfigure This, char * ppszDirectoryName[] UnnamedParameter);
        public GetDirectoryDelegate GetDirectory;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *SetBackingFileCount)(interface IStreamBufferConfigure * This, uint dwMin, uint dwMax);
        public delegate int SetBackingFileCountDelegate(@interface IStreamBufferConfigure This, uint dwMin, uint dwMax);
        public SetBackingFileCountDelegate SetBackingFileCount;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *GetBackingFileCount)(interface IStreamBufferConfigure * This, uint *pdwMin, uint *pdwMax);
        public delegate int GetBackingFileCountDelegate(@interface IStreamBufferConfigure This, ref uint pdwMin, ref uint pdwMax);
        public GetBackingFileCountDelegate GetBackingFileCount;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *SetBackingFileDuration)(interface IStreamBufferConfigure * This, uint dwSeconds);
        public delegate int SetBackingFileDurationDelegate(@interface IStreamBufferConfigure This, uint dwSeconds);
        public SetBackingFileDurationDelegate SetBackingFileDuration;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *GetBackingFileDuration)(interface IStreamBufferConfigure * This, uint *pdwSeconds);
        public delegate int GetBackingFileDurationDelegate(@interface IStreamBufferConfigure This, ref uint pdwSeconds);
        public GetBackingFileDurationDelegate GetBackingFileDuration;
...
//        END_INTERFACE
    ...
    public class IStreamBufferMediaSeekingVtbl
    {
// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: BEGIN_INTERFACE int(STDMETHODCALLTYPE *QueryInterface)(interface IStreamBufferMediaSeeking * This, REFIID riid, object**ppvObject);
        public delegate BEGIN_INTERFACE int QueryInterfaceDelegate(@interface IStreamBufferMediaSeeking This, REFIID riid, object ppvObject[] UnnamedParameter);
        public QueryInterfaceDelegate QueryInterface;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: uint(STDMETHODCALLTYPE *AddRef)(interface IStreamBufferMediaSeeking * This);
        public delegate uint AddRefDelegate(@interface IStreamBufferMediaSeeking This);
        public AddRefDelegate AddRef;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: uint(STDMETHODCALLTYPE *Release)(interface IStreamBufferMediaSeeking * This);
        public delegate uint ReleaseDelegate(@interface IStreamBufferMediaSeeking This);
        public ReleaseDelegate Release;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *GetCapabilities)(interface IStreamBufferMediaSeeking * This, uint *pCapabilities);
        public delegate int GetCapabilitiesDelegate(@interface IStreamBufferMediaSeeking This, ref uint pCapabilities);
        public GetCapabilitiesDelegate GetCapabilities;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *CheckCapabilities)(interface IStreamBufferMediaSeeking * This, uint *pCapabilities);
        public delegate int CheckCapabilitiesDelegate(@interface IStreamBufferMediaSeeking This, ref uint pCapabilities);
        public CheckCapabilitiesDelegate CheckCapabilities;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *IsFormatSupported)(interface IStreamBufferMediaSeeking * This, const GUID *pFormat);
        public delegate int IsFormatSupportedDelegate(@interface IStreamBufferMediaSeeking This, GUID pFormat);
        public IsFormatSupportedDelegate IsFormatSupported;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *QueryPreferredFormat)(interface IStreamBufferMediaSeeking * This, GUID *pFormat);
        public delegate int QueryPreferredFormatDelegate(@interface IStreamBufferMediaSeeking This, GUID pFormat);
        public QueryPreferredFormatDelegate QueryPreferredFormat;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *GetTimeFormat)(interface IStreamBufferMediaSeeking * This, GUID *pFormat);
        public delegate int GetTimeFormatDelegate(@interface IStreamBufferMediaSeeking This, GUID pFormat);
        public GetTimeFormatDelegate GetTimeFormat;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *IsUsingTimeFormat)(interface IStreamBufferMediaSeeking * This, const GUID *pFormat);
        public delegate int IsUsingTimeFormatDelegate(@interface IStreamBufferMediaSeeking This, GUID pFormat);
        public IsUsingTimeFormatDelegate IsUsingTimeFormat;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *SetTimeFormat)(interface IStreamBufferMediaSeeking * This, const GUID *pFormat);
        public delegate int SetTimeFormatDelegate(@interface IStreamBufferMediaSeeking This, GUID pFormat);
        public SetTimeFormatDelegate SetTimeFormat;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *GetDuration)(interface IStreamBufferMediaSeeking * This, long *pDuration);
        public delegate int GetDurationDelegate(@interface IStreamBufferMediaSeeking This, ref long pDuration);
        public GetDurationDelegate GetDuration;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *GetStopPosition)(interface IStreamBufferMediaSeeking * This, long *pStop);
        public delegate int GetStopPositionDelegate(@interface IStreamBufferMediaSeeking This, ref long pStop);
        public GetStopPositionDelegate GetStopPosition;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *GetCurrentPosition)(interface IStreamBufferMediaSeeking * This, long *pCurrent);
        public delegate int GetCurrentPositionDelegate(@interface IStreamBufferMediaSeeking This, ref long pCurrent);
        public GetCurrentPositionDelegate GetCurrentPosition;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *ConvertTimeFormat)(interface IStreamBufferMediaSeeking * This, long *pTarget, const GUID *pTargetFormat, long Source, const GUID *pSourceFormat);
        public delegate int ConvertTimeFormatDelegate(@interface IStreamBufferMediaSeeking This, ref long pTarget, GUID pTargetFormat, long Source, GUID pSourceFormat);
        public ConvertTimeFormatDelegate ConvertTimeFormat;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *SetPositions)(interface IStreamBufferMediaSeeking * This, long *pCurrent, uint dwCurrentFlags, long *pStop, uint dwStopFlags);
        public delegate int SetPositionsDelegate(@interface IStreamBufferMediaSeeking This, ref long pCurrent, uint dwCurrentFlags, ref long pStop, uint dwStopFlags);
        public SetPositionsDelegate SetPositions;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *GetPositions)(interface IStreamBufferMediaSeeking * This, long *pCurrent, long *pStop);
        public delegate int GetPositionsDelegate(@interface IStreamBufferMediaSeeking This, ref long pCurrent, ref long pStop);
        public GetPositionsDelegate GetPositions;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *GetAvailable)(interface IStreamBufferMediaSeeking * This, long *pEarliest, long *pLatest);
        public delegate int GetAvailableDelegate(@interface IStreamBufferMediaSeeking This, ref long pEarliest, ref long pLatest);
        public GetAvailableDelegate GetAvailable;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *SetRate)(interface IStreamBufferMediaSeeking * This, double dRate);
        public delegate int SetRateDelegate(@interface IStreamBufferMediaSeeking This, double dRate);
        public SetRateDelegate SetRate;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *GetRate)(interface IStreamBufferMediaSeeking * This, double *pdRate);
        public delegate int GetRateDelegate(@interface IStreamBufferMediaSeeking This, ref double pdRate);
        public GetRateDelegate GetRate;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *GetPreroll)(interface IStreamBufferMediaSeeking * This, long *pllPreroll);
        public delegate int GetPrerollDelegate(@interface IStreamBufferMediaSeeking This, ref long pllPreroll);
...
public enum AnonymousEnum
{
    ...
    STREAMBUFFER_EC_TIMEHOLE = DefineConstants.STREAMBUFFER_EC_BASE,
