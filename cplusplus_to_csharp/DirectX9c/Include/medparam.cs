...
// C++ TO C# CONVERTER NOTE: The following #define macro was replaced in-line:
// ORIGINAL LINE: #define MP_CAPS_CURVE_JUMP ( MP_CURVE_JUMP )

// C++ TO C# CONVERTER NOTE: The following #define macro was replaced in-line:
// ORIGINAL LINE: #define MP_CAPS_CURVE_LINEAR ( MP_CURVE_LINEAR )

// C++ TO C# CONVERTER NOTE: The following #define macro was replaced in-line:
// ORIGINAL LINE: #define MP_CAPS_CURVE_SQUARE ( MP_CURVE_SQUARE )

// C++ TO C# CONVERTER NOTE: The following #define macro was replaced in-line:
// ORIGINAL LINE: #define MP_CAPS_CURVE_INVSQUARE ( MP_CURVE_INVSQUARE )

// C++ TO C# CONVERTER NOTE: The following #define macro was replaced in-line:
// ORIGINAL LINE: #define MP_CAPS_CURVE_SINE ( MP_CURVE_SINE )

public class _MP_PARAMINFO
{
    public MP_TYPE mpType = new MP_TYPE();
    public uint mopCaps;
    public float mpdMinValue;
    public float mpdMaxValue;
    public float mpdNeutralValue;
    public string szUnitText = new string(new char[32]);
    public string szLabel = new string(new char[32]);
}
...
// C++ TO C# CONVERTER NOTE: The following #define macro was replaced in-line:
// ORIGINAL LINE: #define MPF_ENVLP_BEGIN_CURRENTVAL ( 0x1 )

// C++ TO C# CONVERTER NOTE: The following #define macro was replaced in-line:
// ORIGINAL LINE: #define MPF_ENVLP_BEGIN_NEUTRALVAL ( 0x2 )

public class _MP_ENVELOPE_SEGMENT
{
    public REFERENCE_TIME rtStart = new REFERENCE_TIME();
    public REFERENCE_TIME rtEnd = new REFERENCE_TIME();
    public float valStart;
    public float valEnd;
    public MP_CURVE_TYPE iCurve = new MP_CURVE_TYPE();
    public uint flags;
}

#else // C style interface

    public class IMediaParamInfoVtbl
    {
// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: BEGIN_INTERFACE int(STDMETHODCALLTYPE *QueryInterface)(interface IMediaParamInfo * This, REFIID riid, object**ppvObject);
        public delegate BEGIN_INTERFACE int QueryInterfaceDelegate(@interface IMediaParamInfo This, REFIID riid, object ppvObject[] UnnamedParameter);
        public QueryInterfaceDelegate QueryInterface;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: uint(STDMETHODCALLTYPE *AddRef)(interface IMediaParamInfo * This);
        public delegate uint AddRefDelegate(@interface IMediaParamInfo This);
        public AddRefDelegate AddRef;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: uint(STDMETHODCALLTYPE *Release)(interface IMediaParamInfo * This);
        public delegate uint ReleaseDelegate(@interface IMediaParamInfo This);
        public ReleaseDelegate Release;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *GetParamCount)(interface IMediaParamInfo * This, uint *pdwParams);
        public delegate int GetParamCountDelegate(@interface IMediaParamInfo This, ref uint pdwParams);
        public GetParamCountDelegate GetParamCount;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *GetParamInfo)(interface IMediaParamInfo * This, uint dwParamIndex, _MP_PARAMINFO *pInfo);
        public delegate int GetParamInfoDelegate(@interface IMediaParamInfo This, uint dwParamIndex, _MP_PARAMINFO pInfo);
        public GetParamInfoDelegate GetParamInfo;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *GetParamText)(interface IMediaParamInfo * This, uint dwParamIndex, char **ppwchText);
        public delegate int GetParamTextDelegate(@interface IMediaParamInfo This, uint dwParamIndex, string[] ppwchText);
        public GetParamTextDelegate GetParamText;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *GetNumTimeFormats)(interface IMediaParamInfo * This, uint *pdwNumTimeFormats);
        public delegate int GetNumTimeFormatsDelegate(@interface IMediaParamInfo This, ref uint pdwNumTimeFormats);
        public GetNumTimeFormatsDelegate GetNumTimeFormats;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *GetSupportedTimeFormat)(interface IMediaParamInfo * This, uint dwFormatIndex, GUID *pguidTimeFormat);
        public delegate int GetSupportedTimeFormatDelegate(@interface IMediaParamInfo This, uint dwFormatIndex, GUID pguidTimeFormat);
        public GetSupportedTimeFormatDelegate GetSupportedTimeFormat;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *GetCurrentTimeFormat)(interface IMediaParamInfo * This, GUID *pguidTimeFormat, uint *pTimeData);
        public delegate int GetCurrentTimeFormatDelegate(@interface IMediaParamInfo This, GUID pguidTimeFormat, ref uint pTimeData);
        public GetCurrentTimeFormatDelegate GetCurrentTimeFormat;
...
//        END_INTERFACE
    ...
    public class IMediaParamsVtbl
    {
// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: BEGIN_INTERFACE int(STDMETHODCALLTYPE *QueryInterface)(interface IMediaParams * This, REFIID riid, object**ppvObject);
        public delegate BEGIN_INTERFACE int QueryInterfaceDelegate(@interface IMediaParams This, REFIID riid, object ppvObject[] UnnamedParameter);
        public QueryInterfaceDelegate QueryInterface;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: uint(STDMETHODCALLTYPE *AddRef)(interface IMediaParams * This);
        public delegate uint AddRefDelegate(@interface IMediaParams This);
        public AddRefDelegate AddRef;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: uint(STDMETHODCALLTYPE *Release)(interface IMediaParams * This);
        public delegate uint ReleaseDelegate(@interface IMediaParams This);
        public ReleaseDelegate Release;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *GetParam)(interface IMediaParams * This, uint dwParamIndex, float *pValue);
        public delegate int GetParamDelegate(@interface IMediaParams This, uint dwParamIndex, ref float pValue);
        public GetParamDelegate GetParam;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *SetParam)(interface IMediaParams * This, uint dwParamIndex, float value);
        public delegate int SetParamDelegate(@interface IMediaParams This, uint dwParamIndex, float value);
        public SetParamDelegate SetParam;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *AddEnvelope)(interface IMediaParams * This, uint dwParamIndex, uint cSegments, _MP_ENVELOPE_SEGMENT *pEnvelopeSegments);
        public delegate int AddEnvelopeDelegate(@interface IMediaParams This, uint dwParamIndex, uint cSegments, _MP_ENVELOPE_SEGMENT pEnvelopeSegments);
        public AddEnvelopeDelegate AddEnvelope;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *FlushEnvelope)(interface IMediaParams * This, uint dwParamIndex, REFERENCE_TIME refTimeStart, REFERENCE_TIME refTimeEnd);
        public delegate int FlushEnvelopeDelegate(@interface IMediaParams This, uint dwParamIndex, REFERENCE_TIME refTimeStart, REFERENCE_TIME refTimeEnd);
        public FlushEnvelopeDelegate FlushEnvelope;

// C++ TO C# CONVERTER TODO TASK: The original C++ function pointer contained an unconverted modifier:
// ORIGINAL LINE: int(STDMETHODCALLTYPE *SetTimeFormat)(interface IMediaParams * This, GUID guidTimeFormat, uint mpTimeData);
        public delegate int SetTimeFormatDelegate(@interface IMediaParams This, GUID guidTimeFormat, uint mpTimeData);
